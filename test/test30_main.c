...
puts("plus");return a+b;
}

int minus(int a, int b) {
puts("minus");return a-b;
}
...
int moo(char x, int op1, int op2) {
    ...
    t_fptr = clever(op1,op2,y_fptr.wfptr,x_fptr.wfptr); puts("81:");
